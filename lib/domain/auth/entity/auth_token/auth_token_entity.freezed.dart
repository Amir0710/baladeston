...
abstract class $AuthTokenEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({String accessToken, String refreshToken, Duration expiresIn});
}
...
class _$AuthTokenEntityImpl implements _AuthTokenEntity {
  ...
  @override
  String toString() {
    return 'AuthTokenEntity(accessToken: $accessToken, refreshToken: $refreshToken, expiresIn: $expiresIn)';
  }
...
abstract class _AuthTokenEntity implements AuthTokenEntity {
  const factory _AuthTokenEntity(
      ...
      required final Duration expiresIn}) = _$AuthTokenEntityImpl;
