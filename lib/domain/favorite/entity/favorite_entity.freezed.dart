...
class _$FavoriteEntityImpl implements _FavoriteEntity {
  ...
  @override
  String toString() {
    return 'FavoriteEntity(id: $id, userId: $userId, targetId: $targetId, type: $type, interestedIn: $interestedIn)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, userId, targetId, type, interestedIn);
