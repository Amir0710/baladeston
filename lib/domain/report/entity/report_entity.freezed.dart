...
class _$ReportEntityImpl implements _ReportEntity {
  ...
  @override
  String toString() {
    return 'ReportEntity(id: $id, userId: $userId, targetId: $targetId, response: $response, reportedAt: $reportedAt, reason: $reason, responseAt: $responseAt, status: $status, type: $type)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, userId, targetId, response,
      reportedAt, reason, responseAt, status, type);
...
abstract class _ReportEntity implements ReportEntity {
  const factory _ReportEntity(
      ...
      required final ReportType type}) = _$ReportEntityImpl;
