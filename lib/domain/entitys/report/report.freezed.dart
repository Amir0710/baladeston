...
mixin _$Report {
  ...
  int get hashCode => Object.hash(runtimeType, id, userId, targetId, response,
      reason, reportedAt, responseAt, reportModeledAt);

  @override
  String toString() {
    return 'Report(id: $id, userId: $userId, targetId: $targetId, response: $response, reason: $reason, reportedAt: $reportedAt, responseAt: $responseAt, reportModeledAt: $reportModeledAt)';
  }
}
