...
abstract class DiscountRepository {
  Future<void> createDiscount({required DiscountEntity discount}); // only for admin
  Future<void> editeDiscount({required DiscountEntity discount , required int discountId}); // only for admin
