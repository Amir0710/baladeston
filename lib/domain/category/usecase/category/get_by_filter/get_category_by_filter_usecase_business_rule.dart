...
class GetCategoryByFilterUsecaseBusinessRule {
  final CategoryQueryFilter filter;

  const GetCategoryByFilterUsecaseBusinessRule({
    required this.filter,
  });

  Result<void, CategoryFailure> validate() {
    return _categoryFilterValidation();
  }

  Result<void, CategoryFailure> _categoryFilterValidation() {
    final hasSearchTerm =
