...
abstract class $VerificationEntityCopyWith<$Res> {
  ...
  $Res call(
      ...
      int? expiresIn,
      int? createdAt,
      VerificationPurposeModel purpose});
}
...
class _$VerificationEntityImpl implements _VerificationEntity {
  ...
  @override
  String toString() {
    return 'VerificationEntity(phone: $phone, otpCode: $otpCode, expiresIn: $expiresIn, createdAt: $createdAt, purpose: $purpose)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, phone, otpCode, expiresIn, createdAt, purpose);
