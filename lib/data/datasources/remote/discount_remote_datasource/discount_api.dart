...
abstract class DiscountApi {
  Future<DiscountModel> createDiscount({required DiscountModel discount});
  Future<DiscountModel> editDiscount({required DiscountModel discount});
  ...
  Future<DiscountModel> deleteDiscountById({required int id});
