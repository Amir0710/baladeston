...
class _$ReportModelImpl implements _ReportModel {
  ...
  @override
  String toString() {
    return 'ReportModel(id: $id, userId: $userId, targetId: $targetId, response: $response, reason: $reason, reportedAt: $reportedAt, responseAt: $responseAt, status: $status, type: $type)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, userId, targetId, response,
      reason, reportedAt, responseAt, status, type);
...
abstract class _ReportModel implements ReportModel {
  const factory _ReportModel(
      ...
      required final ReportType type}) = _$ReportModelImpl;
