...
class _$ReactionModelImpl implements _ReactionModel {
  ...
  @override
  String toString() {
    return 'ReactionModel(id: $id, ownerId: $ownerId, targetId: $targetId, interestedIn: $interestedIn, reactionType: $reactionType, targetType: $targetType)';
  }
...
abstract class _ReactionModel implements ReactionModel {
  const factory _ReactionModel(
      ...
      required final TargetType targetType}) = _$ReactionModelImpl;
