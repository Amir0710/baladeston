...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl(
      {required final List<VideoEntity> video, required this.count})
      : _video = video;
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return success?.call(video, count);
  }
...
abstract class _Success implements VideoState {
  const factory _Success(
      {required final List<VideoEntity> video,
...
class __$$FailureImplCopyWithImpl<$Res>
    extends _$VideoStateCopyWithImpl<$Res, _$FailureImpl>
